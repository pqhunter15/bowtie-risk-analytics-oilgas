...
class ExplanationResult:
    ...
    # Phase 4 fields (backward-compatible defaults)
    narrative: str = ""
    citations: list[Any] = field(default_factory=list)
    retrieval_confidence: float = 0.0
    model_used: str = ""
    recommendations: str = ""  # Phase 8 (D-12): default empty for low-confidence path
...
class RAGAgent:
    ...
    def from_directory(
        ...
        barrier_control_ids = [r["control_id"] for r in barrier_meta]
